...
app.post('/api/create-checkout-session', async (req,res)=>{
  try{
    ...
    const discipleCode=String(req.body.discipleCode||'').toUpperCase(); const disciple=d.disciples.find(x=>x.code===discipleCode&&x.status==='active');
